...
/* Esta funcion se utiliza para determinar el a�o en el que ingres� el mayor
...

{
    ...
    for (K = 0; K < PR; K++)//Por cada a�o se suma el ingreso de los semestres de las ocho carreras.
    {
        SUM = 0;
...
numero de alumnos el �ltimo a�o. Observa que no se utiliza un ciclo para los
...
/* Esta funcion se utiliza para determinar el a�o en el que la carrera
