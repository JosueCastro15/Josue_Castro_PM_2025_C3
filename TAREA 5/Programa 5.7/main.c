...
/*Arregglo si elementos repetidos.
El programa, al recibir como dato un arreglo unidimensional desordenado de N
elementos, obtienen como salida ese mismo arreglo paro sin los elementos
repeitodos. */

void Lectura(int *, int);     /*Prototipos de funciones. */
void Imprime(int *, int);
void Elimina(int *, int *);
/*Observa que el prototipo de Elimina, el segundo parametro es por
...
/*Esta Funcion utiliza para eleiminar los elementos repetidos de un arreglo
