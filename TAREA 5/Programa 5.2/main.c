...
/*Eleccion.
El programa almacena los votos emitido en una eleccion en la que hubo cinco
...
void main(void)
{
    ...
    while (VOT != 0)
    {
        if((VOT > 0) && (VOT < 6))  /*Se verifica que el voto sea
            correcto. */
            ELE[VOT-1]++;  /*Los votos se almacenan en el arregl.
        Recuerda que la primera posicion del arreglo es 0, por esa razon a la
        varaible VOT se le descuenta 1. Los votos del primer candidato se
