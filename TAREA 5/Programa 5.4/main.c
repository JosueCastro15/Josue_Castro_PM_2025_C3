...
const int MAX = 10;          /*Se define una constante para el tamano de los
arreglos. */
...
void main(void)
{
    ...
    Lectura(VE1, MAX);
    /* Se llama a lafuncion Lectura. Observa que el paso del arreglo a la funcion
    es por referenci. Solo se debe incluir el nombre del arreglo.*/
