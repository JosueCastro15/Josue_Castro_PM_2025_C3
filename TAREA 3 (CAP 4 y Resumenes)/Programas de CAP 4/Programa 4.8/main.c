...
/* Prototipo de funcio. Observa que los dos parametrso son por
referencia. */
...
void main(void)
{
   ...
   a = 1;   /* Se asigna un valor a la varaible local a. */
   b = 2;   /* Se asignan valores a las varaibles globales b, c y d. */
   c = 3;
   d = 4;
printf("\n%d %d %d %d", a, b, c, d);
...
{
int d;
a = 5;         /* Observa que se hace referencia a la varaible global a. */
