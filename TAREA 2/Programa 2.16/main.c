...
/*Empresa Textil
El programa, al recibir como datos descisivos la categoria y antiguedad de
...
void main(void)
{
    ...
    if (RES)
        printf("\nEl trabajador con clave %d reune las condiciones paraa el puesto", CLA);

    else
        printf ("\nEl trabjador con clave %d no reune las condiciones para el puesto", CLA);
}
